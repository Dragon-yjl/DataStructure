<%@ page language="java" import="java.util.*, java.net.URLEncoder, com.liu.model.*" pageEncoding="UTF-8"%>
            ...
            <ul class="nav">
                ...
                <c:forEach items="${categoryList}" var="category">
                    <li class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-61">
                        <a href="<%=basePath%>loadPageCategory/${category.id}"></span>${category.categoryName}
                        </a></li>
                </c:forEach>
